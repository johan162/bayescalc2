...
class TestCompleter(unittest.TestCase):
    ...
    def test_completion_with_pipe(self):
        ...
        completions = self.completer.get_completions("P(GrassWet=Yes | Rain, Sprinkler=On, G", "G")
        self.assertEqual(completions, ["GrassWet="])
        ...
        completions = self.completer.get_completions("P(GrassWet=Yes | Rain=True, ~Sprinkler=On, G", "G")
        self.assertEqual(completions, ["GrassWet="])
    ...
    def test_command_multiple_arguments_completion(self):
        ...
        completions = self.completer.get_completions("mutual_information(GrassWet, Ra", "Ra")
        self.assertEqual(completions, ["Rain"])
    ...
    def test_command_conditional_argument_completion(self):
        ...
        completions = self.completer.get_completions("iscondindependent(Rain, Sprinkler | Gr", "Gr")
        self.assertEqual(completions, ["GrassWet"])
        
        # Test conditional_entropy command
        completions = self.completer.get_completions("conditional_entropy(GrassWet | Ra", "Ra")
        self.assertEqual(completions, ["Rain"])
