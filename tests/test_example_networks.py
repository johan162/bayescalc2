...
class TestExampleNetworks(unittest.TestCase):
    ...
    def test_alarm_network(self):
        ...
        result = inference.variable_elimination({"Alarm": None}, {"Earthquake": "True", "Burglary": "False"})
    ...
    def test_rain_sprinkler_grass(self):
        ...
        result = inference.variable_elimination({"GrassWet": None}, {"Rain": "True", "Sprinkler": "True"})
    ...
    def test_student_network(self):
        ...
        result = inference.variable_elimination({"Grade": None}, {"Intelligence": "High", "Difficulty": "Easy"})
