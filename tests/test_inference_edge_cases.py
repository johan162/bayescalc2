...
class TestInferenceEdgeCases(unittest.TestCase):
    ...
    def test_numerical_stability(self):
        ...
        def joint_prob(a, b, c, d, e):
            ...
            p_b_given_a = 0.01 if b == "True" and a == "True" else 0.99 if b == "False" and a == "True" else 0.001 if b == "True" and a == "False" else 0.999
            
            p_c_given_b = 0.01 if c == "True" and b == "True" else 0.99 if c == "False" and b == "True" else 0.001 if c == "True" and b == "False" else 0.999
            
            p_d_given_c = 0.01 if d == "True" and c == "True" else 0.99 if d == "False" and c == "True" else 0.001 if d == "True" and c == "False" else 0.999
            
            p_e_given_d = 0.01 if e == "True" and d == "True" else 0.99 if e == "False" and d == "True" else 0.001 if e == "True" and d == "False" else 0.999
            
            return p_a * p_b_given_a * p_c_given_b * p_d_given_c * p_e_given_d
        
        # Calculate P(A=T,E=T) - sum over all possible values of B,C,D
        p_a_true_e_true = sum(joint_prob("True", b, c, d, "True") for b in ["True", "False"] for c in ["True", "False"] for d in ["True", "False"])
        
        # Calculate P(A=F,E=T) - sum over all possible values of B,C,D
        p_a_false_e_true = sum(joint_prob("False", b, c, d, "True") for b in ["True", "False"] for c in ["True", "False"] for d in ["True", "False"])
        ...
        self.assertAlmostEqual(result.probabilities[("True",)], p_a_true_given_e_true, places=10)
    ...
    def test_extreme_evidence_combinations(self):
        ...
        self.assertTrue(result.probabilities[("True",)] > 0.8)  # Should be strongly biased toward True
        ...
        self.assertTrue(result.probabilities[("True",)] < 0.2)  # Should be strongly biased toward False
    ...
    def test_marginal_independence(self):
        ...
        self.assertNotAlmostEqual(result_ac.probabilities[("True",)], result_abc.probabilities[("True",)])
