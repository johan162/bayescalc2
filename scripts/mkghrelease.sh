...
echo ""
echo "=========================================="
echo "  GitHub Release Creator for BayesCalc2"
echo "=========================================="
echo "Repository: bayescalc2"
...
---
For full details, see [CHANGELOG.md](https://github.com/johan162/bayescalc2/blob/main/CHANGELOG.md)
EOF
fi
...
if [[ "$DRY_RUN" == "true" ]]; then
    ...
    echo "URL:     https://github.com/johan162/bayescalc2/releases/tag/$LATEST_TAG"
    echo ""
